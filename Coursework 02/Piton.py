...
def play_game():
    ...
    def placeFood():
        ...
        food1 = canvas.create_rectangle( 0, 0, snakeSize, snakeSize, fill = "#FEFFA5" )
        food1X = random.randint(0, width-snakeSize)
        food1Y = random.randint(0, height-snakeSize)
        canvas.move(food1, food1X, food1Y)

        food2 = canvas.create_rectangle( 0, 0, snakeSize, snakeSize, fill = "#931F1D" )
    ...
    def growSnake(grow_2blocks = False):
        ...
        snake.append(canvas.create_rectangle(0, 0, snakeSize, snakeSize, fill="#ABC798"))
    ...
    def endScreen():
        ...
        game_over = Label(window, text = "GAME OVER!", font = ("Times 50 italic bold"), bg = "#ABC798", fg = "#1A1F16")
        game_over.place( x= 200 , y= 200)

        end_score = Label(window, text = "Your Score: " + str(score), font = ("Times 30 italic bold"), bg = "#ABC798", fg = "#1A1F16")
        end_score.place( x= 200 , y= 300)

        back_to_menu_button = Button(text = "Back to Menu", bg = "#5D737E", activebackground = "#D68C45", height = 2 ,width = 15, font = ("Arial, 15"), command = backToMenu)
    ...
    snake = []
    snakeSize = 20
    snake.append(canvas.create_rectangle(snakeSize, snakeSize, snakeSize * 2, snakeSize * 2, fill = "#60992D" ))
...
def menu_page():
    ...
    playButton = Button(menu_window, text = "Start", bg = "#5D737E", activebackground = "#D68C45", height = 2 ,width = 15, font = ("Arial, 15"), command = play_game)
    playButton.place( x = 200, y = 300)

    rulesButton = Button(menu_window, text = "Rules", bg = "#5D737E", activebackground = "#D68C45", height = 2 ,width = 15, font = ("Arial, 15"), command = rules_page)
    rulesButton.place( x = 200, y = 400)

    leaderboardButton = Button(menu_window, text = "Leaderboard", bg = "#5D737E", activebackground = "#D68C45", height = 2 ,width = 15, font = ("Arial, 15"))
    leaderboardButton.place( x = 200, y = 500)

    settingsButton = Button(menu_window, text = "Settings", bg = "#5D737E", activebackground = "#D68C45", height = 2 ,width = 15, font = ("Arial, 15"))
    settingsButton.place( x = 200, y = 600)

    exitButton = Button(menu_window, text = "Exit", bg = "#5D737E", activebackground = "#D68C45", height = 2 ,width = 15, font = ("Arial, 15"), command = menu_window.destroy)
